	...
	if (isset($_POST['login'])) {
		...
		try {
			...
			{	fwrite($f, "\n Found : ");
				...
				if($acc_dets)
				{
					$table= "</br><h1><section-header>Your Account Details&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</section-header></h1><br/><br/><table> <tr><td>Login id: </td><td>$user_name</td></tr><tr><td>Services: </td><td>$user_name</td></tr></table>";
