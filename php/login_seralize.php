<?php
	...
	if (isset($_POST['login'])) {
		...
		$found = false; $table = ''; $user_type =''; $user_name =''; $acc_dets = '';
		...
		//$acc = unserialize(serialize($acc_dets));
		
$json = array( "isSuccess" => $found, "loginid" => $login, "user_type" => $user_type, "acc_dets" => unserialize(serialize($acc_dets)));
//		$json = array( "isSuccess" => $found, "loginid" => $login, "user_type" => $user_type);
